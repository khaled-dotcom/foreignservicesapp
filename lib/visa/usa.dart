...
class usaVisa extends StatelessWidget {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10,),
              Text("2. USA Visa Application Form: ",style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold,fontSize: 15.0),),
              Container(
              ...
              SizedBox(height: 10,),
              Text("10.USA Visa Fee:",style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold,fontSize: 15.0),),
              Container(
                  child:Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("a. 13,120/-",style: TextStyle(fontWeight: FontWeight.bold),),
