...
class ThaiVisa extends StatefulWidget {
  @override
  _ThaiVisaState createState() => _ThaiVisaState();
}

class _ThaiVisaState extends State<ThaiVisa> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 10,),
              Text("2. Thailand Visa Application Form: ",style: TextStyle(color: Colors.blue[900],fontWeight: FontWeight.bold,fontSize: 15.0),),
              Container(
              ...
              Container(
                  child:Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("a. 3840/- (Single Entry)",style: TextStyle(fontWeight: FontWeight.bold),),
                      Text("b. 15040/- (Multiple Entry)",style: TextStyle(fontWeight: FontWeight.bold)),
                    ],
                  )
              ),
